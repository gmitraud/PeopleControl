...
class MunicipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipe" do
    assert_difference('Municipe.count') do
      post municipes_url, params: { municipe: { birthdate: @municipe.birthdate, cns: @municipe.cns, cpf: @municipe.cpf, email: @municipe.email, fullname: @municipe.fullname, phone: @municipe.phone, photo: @municipe.photo, status: @municipe.status } }
    end
  ...
  test "should update municipe" do
    patch municipe_url(@municipe), params: { municipe: { birthdate: @municipe.birthdate, cns: @municipe.cns, cpf: @municipe.cpf, email: @municipe.email, fullname: @municipe.fullname, phone: @municipe.phone, photo: @municipe.photo, status: @municipe.status } }
